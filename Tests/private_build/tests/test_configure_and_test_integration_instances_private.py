...
def test_create_install_private_testing_pack(mocker):
    ...
    def mocked_generic_request_func(_self, path: str, method, body=None, accept=None,
...
def test_install_packs_private(mocker):
    ...
    mocker.patch('Tests.Marketplace.search_and_install_packs.get_pack_and_its_dependencies')
